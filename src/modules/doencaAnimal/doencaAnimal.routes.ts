...
// /**
//  * Essas rotas serão montadas com prefixo:
...
//  * @swagger
//  * tags:
//  *   - name: Doenças do Animal
//  *     description: Relação de doenças por animal
//  */

// /**
//  * @swagger
//  * /api/doencas-animal/animal/{idAnimal}:
//  *   get:
//  *     summary: Lista todas as doenças (ativas e históricas) de um animal
...
//   "/animal/:idAnimal",
//   authMiddleware,
//   controller.listByAnimal
// );

// /**
//  * @swagger
//  * /api/doencas-animal/animal/{idAnimal}/ativas:
//  *   get:
//  *     summary: Lista apenas as doenças ativas de um animal
//  *     tags: [Doenças do Animal]
//  *     parameters:
//  *       - in: path
//  *         name: idAnimal
...
//  *     responses:
//  *       200:
//  *         description: Lista de doenças ativas
//  *       404:
//  *         description: Nenhum registro encontrado
//  */
// router.get(
//   "/animal/:idAnimal/ativas",
//   authMiddleware,
//   controller.listAtivasByAnimal
// );
...
//  * /api/doencas-animal/animal/{idAnimal}:
//  *   post:
//  *     summary: Cadastra uma doença para o animal
//  *     tags: [Doenças do Animal]
//  *     parameters:
//  *       - in: path
//  *         name: idAnimal
 ...
 * app.use("/api/doencas-animal", doencaAnimalRoutes);
 *
 * Ou seja, o path final fica, por exemplo:
 *  - GET    /api/doencas-animal/animal/:idAnimal
 *  - POST   /api/doencas-animal/animal/:idAnimal
 *  - PUT    /api/doencas-animal/:id
 *  - DELETE /api/doencas-animal/:id
 */
const router = Router();
const controller = container.resolve(DoencaAnimalController);
