import { PrismaClient, SexoAnimal, FrequenciaVacina, TipoRaca, StatusAnimal, Porte } from "@prisma/client";
  ...
  const usuarios = [
    {
      ...
      senha: "$2a$12$nFxZ7y6hWAsXiE.bStThG.82hWkBarl7m5fLqzur72GFBuZ/XmEoq", // hash de "123456"
      cpf: "12345678900",
